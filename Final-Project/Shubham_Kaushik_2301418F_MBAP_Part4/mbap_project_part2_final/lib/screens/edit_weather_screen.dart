...
class EditWeatherForm extends StatelessWidget {
  ...
  if (isValid) {
    ...
    weatherService.updateWeather(id, weatherCondition!, weatherTemp!).then((value) {
      FocusScope.of(context).unfocus();
      Navigator.of(context).pop();
      ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Weather updated successfully!'),)
      );
    });
  }
  }
  ...
  Widget build(BuildContext context) {
    Weather selectedWeather = ModalRoute.of(context)?.settings.arguments as Weather;
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(onPressed: () {saveForm(selectedWeather.weatherID, context);}, child: const Text('Update Weather'))
              ],
            ),
          ),
        ));
